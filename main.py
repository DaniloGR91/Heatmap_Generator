...
from preview import *
from PyQt5.QtWidgets import QDialog, QMainWindow, QApplication, QDialogButtonBox, QFileDialog
...
class Heatmap_generator(QMainWindow, Ui_MainWindow):
    ...
    def preview(self):
        if self.dataset_opened:
            ...
            self.label_status.setText('Escolha um arquivo antes de solicitar o Preview')
    ...
    def set_config(self):
        ...
        self.correlation_type = str(self.comboBox_correlation_type.currentText())
